$(document).ready(function () {
    ...
    $('#run').click(async function () {
        if (src_node != null && dest_node != null) {
            ...
            var prev = await Dijkstra(srcIndex, destIndex);
            var path = await reconstructPath(prev, srcIndex, destIndex);
            ...
            async function Dijkstra(src, dest) {
                ...
                while (!pq.isEmpty() && flag) {
                    ...
                    if (typeof visited[elemIndex] == "undefined") {
                        ...
                        ////
                        if (elemIndex != src && elemIndex != dest) {
                            $('#square' + elemIndex).attr("type", "check");
                        }
                        ////
                        visited[elemIndex] = 1;
            ...
            async function reconstructPath(prev, src, dest) {
                // await Dijkstra();
                var path_temp = [];
                var path = [];
                path_temp.push(dest);
